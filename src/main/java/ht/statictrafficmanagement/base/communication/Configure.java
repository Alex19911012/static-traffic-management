...
//@ConfigurationProperties(prefix = "udpsocket")
@Component
public class Configure {
	//@Value("${udpsocket.udp_port}")
    private int udp_port = 7778;
	//@Value("${udpsocket.receive_packet_max_length}")
    private int receive_packet_max_length = 1000;
	//@Value("${udpsocket.send_packet_max_length}")
    private int send_packet_max_length = 1000;
	//@Value("${udpsocket.resend_message_interval}")
    private int clear_sent_message_interval = 2;
	//@Value("${udpsocket.clear_sent_message_interval}")
    private int resend_message_interval = 30;
